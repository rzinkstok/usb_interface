...
set rc [catch {
  ...
  add_files -quiet C:/Users/rzine07792/source/rzinkstok/usb_interface/fpga/usb_interface.runs/synth_1/toplevel.dcp
...
set rc [catch {
  ...
  power_opt_design 
  write_checkpoint -force toplevel_pwropt.dcp
