...
HD_PWD='/home/rzinkstok/usb_interface/fpga/usb_interface.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log usb_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source usb_interface.tcl -notrace
