...
HD_PWD='C:/Users/rzine07792/source/rzinkstok/usb_interface/fpga/usb_interface.runs/cmd_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmd_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmd_fifo.tcl
