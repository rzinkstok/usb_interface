...
set_property DRIVE 8 [get_ports cmd_ready]
...
set_property DRIVE 8 [get_ports {cmd_byte_debug[0]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[1]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[2]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[3]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[4]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[5]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[6]}]
set_property DRIVE 8 [get_ports {cmd_byte_debug[7]}]