...
HD_PWD='/home/rzinkstok/usb_interface/fpga/usb_interface.runs/read_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log read_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source read_fifo.tcl
