...
HD_PWD='/home/rzinkstok/usb_interface/fpga/usb_interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usb_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usb_interface.tcl
